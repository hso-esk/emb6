...
#include "sf_cc13xx_868_95.h"
#include "rflib/radio_par.h"

/* Custom data strucure(s) */

/* Overrides for CMD_PROP_RADIO_DIV_SETUP */
uint32_t RF_868_95_pOverrides[] =
{
    // override_use_patch_prop_genfsk.xml
    // PHY: Run the WMBus patch, run RFE from ROM
    ...
    // AGC settle wait =18 samples
    HW_REG_OVERRIDE(0x608C,0x0007),
    // Set CS threshold to -107 dBm
    HW_REG_OVERRIDE(0x6090,0xA095),
    // Let the patch control the correlator setting
    (uint32_t)0x00048103,
    HW_REG_OVERRIDE(0x51F8, 0x0000),
    // Transmit T-mode
    HW_REG_OVERRIDE(0x52B4, 0x0000),
    (uint32_t)0xFFFFFFFF,
};

uint32_t RF_868_95_NRZ_pOverrides[] =
{
// override_synth.xml
...
rfc_CMD_PROP_RADIO_DIV_SETUP_t RF_868_95_cmdPropRadioDivSetup =
{
    .commandNo                  = 0x3807,
    .status                     = 0x0000,
    ...
    .pRegOverride               = RF_868_95_NRZ_pOverrides,
    .txPower                    = 0xA73F,
    .centerFreq                 = 0x0364,
    .intFreq                    = 0x8000,
    .loDivider                  = 0x05,
...
// CMD_PROP_TX_ADV
rfc_CMD_PROP_TX_ADV_t RF_868_95_cmdPropTxAdv =
{
    .commandNo = 0x3803,
    .status = 0x0000,
    .pNextOp = 0, /*INSERT APPLICABLE POINTER: (uint8_t*)&xxx */
...
// CMD_PROP_RX_ADV
rfc_CMD_PROP_RX_ADV_t RF_868_95_cmdPropRxAdv =
{
    .commandNo = 0x3804,
    .status = 0x0000,
    .pNextOp = 0, /*INSERT APPLICABLE POINTER: (uint8_t*)&xxx */
