...
/*==============================================================================
                            TYPEDEF STRUCT
==============================================================================*/
/* Enumeration for the sf_rf_6lowpan_cca() function. */
typedef enum
{
  /** No signal detected. Channel is free */
  E_RF_6LOWPAN_CCA_RESULT_IDLE,
  /** Signal detected */
  E_RF_6LOWPAN_CCA_RESULT_BUSY,
  /* Transceiver is busy with sending or receiving */
  E_RF_6LOWPAN_CCA_RESULT_INVALID_RF_STATE
}E_RF_6LOWPAN_CCA_RESULT_t;
/*==============================================================================
                            FUNCTIONS
==============================================================================*/
 ...
 *
 * @return  @ref E_RF_6LOWPAN_CCA_RESULT_IDLE if no signal is detected,
 *          @ref E_RF_6LOWPAN_CCA_RESULT_BUSY if a signal was detected and
 *          @ref E_RF_6LOWPAN_CCA_RESULT_INVALID_RF_STATE when transceiver
