...
/** Enumeration for the sf_rf_cca() function. */
typedef enum
{
...
/* Request the current handle of the transceiver. If no handle is availabl NULL
 * will be returned */
RF_Handle* sf_rf_getHandle(void);
/* Enables or disables the T/C patch. This function must be called before the
 * the function sf_rf_init() is called */
...
/*============================================================================*/
/**
 * @brief  Performs a clear channel assessment.
 *
 ...
 *
 * @return  @ref E_RF_CCA_RESULT_IDLE if no signal is detected,
 *          @ref E_RF_CCA_RESULT_BUSY if a signal was detected and
 *          @ref E_RF_CCA_RESULT_INVALID_RF_STATE when transceiver
 *               is busy with sending or receiving.
 */
/*============================================================================*/
