...
rfc_CMD_PROP_RADIO_DIV_SETUP_t RF_802_15_4_ch26_cmdPropRadioDivSetup =
{
    .commandNo = 0x3807,
    .status = 0x0000,
...
// CMD_FS
rfc_CMD_FS_t RF_802_15_4_ch26_cmdFs =
{
    .commandNo = 0x0803,
    .status = 0x0000,
    .pNextOp = 0, // INSERT APPLICABLE POINTER: (uint8_t*)&xxx
...
rfc_CMD_PROP_TX_ADV_t RF_802_15_4_ch26_cmdPropTxAdv_test =
{
    ...
    .numHdrBits = 0x8,          // Number of bits in header (0�32)
...
rfc_CMD_PROP_RX_ADV_t RF_802_15_4_ch26_cmdPropRxAdv_test =
{
    ...
    .rxConf.bAppendRssi = 0x0,        // If 1, append an RSSI byte to the packet in the RX queue
