 ...
 * @date    12.11.2015
 * @author  PN
 * @brief   Header file of TI transceiver CC112X
 */

#ifndef CC112X_PRESENT
#define CC112X_PRESENT
...
#define CC112X_BURST_RXFIFO             0x00FF      /*  RXFIFO  - Burst access to Receive FIFO  */
...
#define CC112X_STATE_CHIP_RDYn          0x80
