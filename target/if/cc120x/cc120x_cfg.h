...
static const s_regSettings_t rf_cfg_ch_434mhz50bps[] =
{
    ...
    {CC120X_SYNC_CFG0,      0x23},  /* AUTO_CLEAR = 1, enabled
                                     * RX_CONFIG_LIMITATION = 0,
                                     **/

    {CC120X_MODCFG_DEV_E,   0x0B},  /* MOD_FORMAT = 001, 2-GFSK;
                                     * DEV_E = 011, Frequency deviation
                                     **/

    {CC120X_PREAMBLE_CFG1,  0x30},  /* NUM_PREAMBLE = 1100, 24 bytes
                                     * PREAMBLE_WORD = 00, 0xAA
                                     **/

    {CC120X_PREAMBLE_CFG0,  0x8A},  /* PQT_EN = 1, Preamble detection disabled
