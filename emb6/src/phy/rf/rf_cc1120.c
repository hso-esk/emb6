/**
 * @file    cc1120_cc1120.c
 * @date    Oct 16, 2015
 * @author  PN
 * @brief   Implementation of radio transceiver TI CC1120
 */
...
********************************************************************************
*/
void cc1120_init(void *p_cfg, ETH_ERR *p_err);
void cc1120_deinit(ETH_ERR *p_err);
void cc1120_on(ETH_ERR *p_err);
void cc1120_off(ETH_ERR *p_err);
void cc1120_send(uint8_t *p_data, uint16_t len, ETH_ERR *p_err);
void cc1120_recv(uint8_t *p_data, uint16_t len, ETH_ERR *p_err);
void cc1120_ioctrl(ETH_IOC_CMD cmd, void *p_val, ETH_ERR *p_err);
...
static void cc112x_Init (s_ns_t *p_netstack, RADIO_ERR *p_err)
{
    ...
    if (mac_phy_config.mac_address == NULL) {
        ...
        _cc1120212_setPanAddr(mac_phy_config.pan_id, 0, (uint8_t *)&un_addr.u8);
        rimeaddr_emb6_set_node_addr(&un_addr);
        _cc1120212_setChannel(CHANNEL_802_15_4);
    }
#endif
}
