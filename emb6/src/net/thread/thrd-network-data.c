...
//
//	LOG_RAW("thrd_on_mesh_prefix_set_lookup: Looking up On-Mesh Prefix.\n\r");
//
//	found_prefix = NULL;
...
//		LOG_RAW("thrd_on_mesh_prefix_set_lookup: Found On-Mesh Prefix.\n\r");
//	} else {
//		LOG_RAW("thrd_on_mesh_prefix_set_lookup: No On-Mesh Prefix found.\n\r");
//	}
//	return found_prefix;
//}
//
...
//
//	LOG_RAW("thrd_ext_route_set_lookup: Looking up External Route Set for Domain ID: ");
//	LOG_RAW("%d.", domain_id);
//	LOG_RAW("\n\r");
//
...
//		LOG_RAW("thrd_ext_route_set_lookup: Found Domain ID: %d.\n\r", domain_id);
//	} else {
//		LOG_RAW("thrd_ext_route_set_lookup: No Domain ID found.\n\r");
//	}
...
//
//	LOG_RAW("thrd_sicslowpan_ctx_id_set_lookup: Looking up 6LoWPAN Context ID: ");
//	LOG_RAW("%d.", sicslowpan_ctx_id);
//	LOG_RAW("\n\r");
//
//	found_ctx_id = NULL;
...
//		LOG_RAW("thrd_sicslowpan_ctx_id_set_lookup: Found 6LoWPAN Context ID: %d.\n\r", sicslowpan_ctx_id);
//	} else {
//		LOG_RAW("thrd_sicslowpan_ctx_id_set_lookup: No 6LoWPAN Context ID found.\n\r");
//	}
//	return found_ctx_id;
//}
//
...
//
//	LOG_RAW("thrd_server_set_lookup: Looking up Server Set.\n\r");
//
//	found_server = NULL;
...
//		LOG_RAW("thrd_server_set_lookup: Found Server.\n\r");
//	} else {
//		LOG_RAW("thrd_server_set_lookup: No Server found.\n\r");
//	}
//	return found_server;
//}
//
...
//
//	if ( pref == NULL ) {
//		LOG_RAW("thrd_on_mesh_prefix_set_add: On-Mesh Prefix unknown.\n\r");
//
...
//			LOG_RAW("thrd_on_mesh_prefix_set_add: Could not allocate On-Mesh Prefix.\n\r");
//			return NULL;
//		}
...
//		LOG_RAW("thrd_on_mesh_prefix_set_add: Added On-Mesh Prefix.\n\r");
//		num_on_mesh_prefixes++;
//		LOG_RAW("thrd_on_mesh_prefix_set_add: num_on_mesh_prefixes %d\n\r", num_on_mesh_prefixes);
//	} else {
//
//		LOG_RAW(ANSI_COLOR_RED "thrd_on_mesh_prefix_set_add: On-Mesh Prefix is already known.\n\r");
//		LOG_RAW("thrd_on_mesh_prefix_set_add: num_on_mesh_prefixes %d\n\r", num_on_mesh_prefixes);
//		LOG_RAW("-----------------------------------------------------\n\r");
//		return NULL;
//	}
...
//
//	if ( ext_route == NULL ) {
//		LOG_RAW("thrd_ext_route_set_add: External Route unknown.\n\r");
//
...
//			// This should not happen, as we explicitly deallocated one
//			// link set entry above.
//			LOG_RAW("thrd_ext_route_set_add: Could not allocate External Route.\n\r");
//			return NULL;
//		}
...
//		LOG_RAW("thrd_ext_route_set_add: Added External Route.\n\r");
//		num_ext_routes++;
//		LOG_RAW("thrd_ext_route_set_add: num_ext_routes %d\n\r", num_ext_routes);
//	} else {
//
//		LOG_RAW(ANSI_COLOR_RED "thrd_ext_route_set_add: External Route is already known.\n\r");
//		LOG_RAW("thrd_ext_route_set_add: num_ext_routes %d\n\r", num_ext_routes);
//		LOG_RAW("-----------------------------------------------------\n\r");
//		return NULL;
//	}
...
//
//	if ( ctx_id == NULL ) {
//		LOG_RAW("thrd_sicslowpan_ctx_id_set_add: External Route unknown.\n\r");
//
...
//			// This should not happen, as we explicitly deallocated one
//			// link set entry above.
//			LOG_RAW("thrd_sicslowpan_ctx_id_set_add: Could not allocate 6LoWPAN Context ID.\n\r");
//			return NULL;
//		}
...
//		LOG_RAW("thrd_sicslowpan_ctx_id_set_add: Added 6LoWPAN Context ID.\n\r");
//		num_sicslowpan_ctx_ids++;
//		LOG_RAW("thrd_sicslowpan_ctx_id_set_add: num_sicslowpan_ctx_ids %d\n\r", num_sicslowpan_ctx_ids);
//	} else {
//
//		LOG_RAW(ANSI_COLOR_RED "thrd_sicslowpan_ctx_id_set_add: 6LoWPAN Context ID is already known.\n\r");
//		LOG_RAW("thrd_sicslowpan_ctx_id_set_add: num_sicslowpan_ctx_ids %d\n\r", num_sicslowpan_ctx_ids);
//		LOG_RAW("-----------------------------------------------------\n\r");
//		return NULL;
//	}
...
//
//	if ( server == NULL ) {
//		LOG_RAW("thrd_server_set_add: External Route unknown.\n\r");
//
...
//			// This should not happen, as we explicitly deallocated one
//			// link set entry above.
//			LOG_RAW("thrd_server_set_add: Could not allocate 6LoWPAN Context ID.\n\r");
//			return NULL;
//		}
...
//		server->S_id = id;
//		LOG_RAW("thrd_server_set_add: Added 6LoWPAN Context ID.\n\r");
//		num_servers++;
//		LOG_RAW("thrd_server_set_add: num_servers %d\n\r", num_servers);
//	} else {
//
//		LOG_RAW(ANSI_COLOR_RED "thrd_server_set_add: 6LoWPAN Context ID is already known.\n\r");
//		LOG_RAW("thrd_server_set_add: num_servers %d\n\r", num_servers);
//		LOG_RAW("-----------------------------------------------------\n\r");
//		return NULL;
//	}
...
//{
//	if ( pref != NULL ) {
//		LOG_RAW("thrd_on_mesh_prefix_set_rm: Removing On-Mesh Prefix from On-Mesh Prefix Set.\n\r");
//		list_remove(on_mesh_prefix_list, pref);
//		memb_free(&on_mesh_prefix_memb, pref);
//		num_on_mesh_prefixes--;
//		LOG_RAW("thrd_on_mesh_prefix_set_rm: num_on_mesh_prefixes %d\n\r", num_on_mesh_prefixes);
//	}
//}
//
///* --------------------------------------------------------------------------- */
...
//{
//	if ( ext_route != NULL ) {
//		LOG_RAW("thrd_ext_route_set_rm: Removing External Route from External Route Set.\n\r");
//		list_remove(ext_route_list, ext_route);
//		memb_free(&ext_route_memb, ext_route);
//		num_ext_routes--;
//		LOG_RAW("thrd_ext_route_set_rm: num_ext_routes %d\n\r", num_ext_routes);
//	}
//}
//
///* --------------------------------------------------------------------------- */
...
//{
//	if ( ctx_id != NULL ) {
//		LOG_RAW("thrd_sicslowpan_ctx_id_set_rm: Removing 6LoWPAN Context ID from 6LoWPAN Context ID Set.\n\r");
//		list_remove(sicslowpan_ctx_id_list, ctx_id);
//		memb_free(&sicslowpan_ctx_id_memb, ctx_id);
//		num_sicslowpan_ctx_ids--;
//		LOG_RAW("thrd_sicslowpan_ctx_id_set_rm: num_sicslowpan_ctx_ids %d\n\r", num_sicslowpan_ctx_ids);
//	}
//}
//
///* --------------------------------------------------------------------------- */
...
//{
//	if ( server != NULL ) {
//		LOG_RAW("thrd_server_set_rm: Removing Server from Server Set.\n\r");
//		list_remove(server_list, server);
//		memb_free(&server_memb, server);
//		num_servers--;
//		LOG_RAW("thrd_server_set_rm: num_servers %d\n\r", num_servers);
//	}
//}
//
///*
...
//{
//	LOG_RAW("Initializing Thread Network Data.\n\r");
