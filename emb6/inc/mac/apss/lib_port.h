...
#define LED_BROADCAST_ON()          bsp_led(E_BSP_LED_RED, E_BSP_LED_ON)
#define LED_BROADCAST_OFF()         bsp_led(E_BSP_LED_RED, E_BSP_LED_OFF)
...
#define LED_SCAN_ON()
#define LED_SCAN_OFF()
#define LED_BROADCAST_OFF()
#define LED_BROADCAST_ON()
#define LED_ERROR()
#endif
